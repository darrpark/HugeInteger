...
namespace HugeIntegers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HugeInteger firstNum = new HugeInteger();
            HugeInteger secondNum = new HugeInteger();
            ...
            {
                properInput = false;
                Console.Write("Enter the value of the first integer: ");
                firstNum.FillHugeIntArray(Console.ReadLine());
                Console.Write("Enter the value of the second integer: ");
                secondNum.FillHugeIntArray(Console.ReadLine());

                while (properInput == false)
                {
                    Console.Write("What operation? 1 for Add, 2 for Sub, 3 for Mult, 4 for Div: ");
                    ...
                    {
                        result = result.Subtract(firstNum, secondNum);
                        Console.WriteLine(result.ToString() + "\n");
                        properInput = true;
                    }
                    else if (operation == "3")
                    ...
                    {
                        result = result.GetQuotient(firstNum, secondNum);
                        Console.WriteLine(result.ToString() + "\n");
                        properInput = true;
                    }
                    else
